...
Usage: NodeChiSquare Node_SNP_counts.ML 0.0001
=cut
use warnings;
use strict;
...
if ($help) {
    ...
    print "-p and -t are optional. Default is -p 0.0001 -t ML\n";
    exit;
}

my $nodeSNPcountfile="Node_SNP_counts.".$tree_type;
my $intree="tree_nodeLabel.".$tree_type.".tre";
